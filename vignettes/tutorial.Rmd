...
Here we see that the coefficient for gdpPercap is about 4.789. That is to say, if gdpPercap increases by one unit, the mean life expectancy will increase by 4.789. The hypothesis test associated with the gdpPercap coefficient: 
null hypothesis: gdpPercap coefficient = 0 (there's no relationship between gdpPercap and lifeExp)
alternative hypothesis: gdpPercap coefficient is not equal to 0 (two sided test)
